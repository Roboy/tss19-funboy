...
class SpeechEmotionRecognition:
    ...
    def voice_recording(filename, duration=5, sample_rate=16000, chunk=1024, channels=1):
        ...
        while (current_time - start_time) < duration*1000:
        ...
        return p.get_sample_size(pyaudio.paInt16), frames
    ...
    def predict_emotion_from_file(self, filename,
        ...
        # Read audio file
        y, sr = librosa.core.load(filename, sr=sample_rate, offset=offset, duration=duration)
